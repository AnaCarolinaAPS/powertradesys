                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('registro_caixa.index', ['ano' => request('ano', \Carbon\Carbon::parse($fechamento->start_date)->format('Y')), 'mes' => \Carbon\Carbon::parse($fechamento->start_date)->format('n')]); }}">Registro de Caixas</a></li>
