...
class PDFController extends Controller
{
    ...
    public function vendaPDF(Venda $venda)
    {
        ...
        // Renderize a view 'pdf.pagina' para HTML
        $html = view('admin.pdf.vendas', compact('venda'))->render();
        ...
        $data = \Carbon\Carbon::parse($venda->data)->format('d-m-Y');
        $nome_documento = $venda->numero_factura."-".$venda->cliente->user->name."-".$data.".pdf";

        // Envie o PDF gerado para o navegador
        return $dompdf->stream($nome_documento);
        // return view('admin.pdf.vendas', compact('venda'));
    }
}
