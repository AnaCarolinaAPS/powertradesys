    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Vendas</h4>
                        ...
                        <div class="table-responsive">
                            <table id="datatable-date" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    @foreach ($all_items as $venda)
                                    <tr data-href="{{ route('vendas.show', ['venda' => $venda->id]) }}">
                                        <td>{{ $venda->data }}</td>
                                        <td>{{ \Carbon\Carbon::parse($venda->data)->format('d/m/Y') }}</td>
                                        <td>{{ $venda->numero_factura }}</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Nova Venda</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="form-horizontal mt-3" method="POST" action="{{ route('vendas.store') }}#" id="formNovoItem">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" id="condicao_venda" name="condicao_venda" required>
